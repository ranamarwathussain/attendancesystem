                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <label class="form-control-label">Select Start Date<span class="text-danger ml-2">*</span></label>
                            <input type="date" class="form-control" name="sdateTaken" id="exampleInputFirstName" placeholder="Select Start Date">
                        </div>
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <label class="form-control-label">Select End Date<span class="text-danger ml-2">*</span></label>
                            <input type="date" class="form-control" name="edateTaken" id="exampleInputFirstName" placeholder="Select End Date">
                        </div>
                       
                    </div>
                    <button type="submit" name="view" class="btn btn-primary">View Attendance Between Range</button>
                  </form>
                </div>
              </div>
...
////////////////////
                      $query = "SELECT * from tblattendance where classId='".$result1['tclassid']."' and classArmId='".$result1['tclasssectionid']."' and dateTimeTaken between 
                      '$sdateTaken' AND  '$edateTaken' ORDER BY firstName ASC;";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
                      ...
                      '$sdateTaken' AND  '$edateTaken' ";
                            ...
                            echo"
                              <tr>
                                ...
                                <td style='background-color:".$colour.";color='#ffffff';'>".$status."</td>
...
<!--Get Percentage -->
  ...
  <!-- Input Group -->
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Class Attendance Percentage</h6>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead class="thead-light">
                  ...
                  <?php
                   if(isset($_POST['view'])){
                      ...
                      <form action="getreport.php" method="post">
                          <input type='hidden' name='sdateTaken' value="<?php  echo $sdateTaken;?>"/>
                          <input type='hidden' name='edateTaken' value="<?php  echo $edateTaken;?>"/>
                          <input type='hidden' name='sectionId' value="<?php  echo $sectionId;?>"/>
                     
                      <button type='submit' name='submit' class='btn btn-primary btn-block' >Get Report</button>
                      </form>
                      <?php
                   }
                   ?>
