...
$query = "select * from studentenroll where classArmId='$sectionId' AND sessionyear='$sessionyear';";
                    ...
                    //////////////
                      $query = "select *,student_info.regnumber  from studentenroll JOIN student_info ON student_info.stdid=studentenroll.admissionNumber where studentenroll.classArmId='$sectionId' AND studentenroll.sessionyear='$sessionyear' ORDER BY studentenroll.firstName ASC, studentenroll.lastName ASC,studentenroll.admissionNumber ASC;";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
