       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewAttendance.php">View Class Attendance(Day)</a>
            <a class="collapse-item" href="viewMonthatt.php">View Class Attendance(Range)</a>
            
          <!--  <a class="collapse-item" href="viewStudentAttendance.php">View Student Attendance</a>-->
            <a class="collapse-item" href="attendancereport.php">Attendance Report</a>
