                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="className" value="<?php echo $row['className'];?>" id="exampleInputFirstName" placeholder="Class Name" oninput="this.value = this.value.toUpperCase()">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
