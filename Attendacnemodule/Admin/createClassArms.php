            ...
            <div class="col-lg-12">
                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <label class="form-control-label">Select Class<span class="text-danger ml-2">*</span></label>
                         <?php
                        $qry= "SELECT * FROM program ORDER BY pcode ASC";
                      ...
                      <input type="text" class="form-control" name="classArmName" value="<?php echo $row['classArmName'];?>" id="exampleInputFirstName" placeholder="Class Arm Name" oninput="this.value = this.value.toUpperCase()">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblclassarms.Id,tblclassarms.isAssigned,program.pname,tblclassarms.classArmName 
                      FROM tblclassarms
                      INNER JOIN program ON program.pid= tblclassarms.classId";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
