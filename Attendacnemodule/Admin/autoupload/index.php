...
<div class="card-body">
  ...
  <strong>Success!</strong> You Can Upload Excel Sheet here !! Required Columns in Excel Sheet as FristName, LastName, Email, Phone No!
                  ...
                  <form method="POST" action="submitfile.php" enctype="multipart/form-data">
                  <input type="file" name="excel"/>
                  <input type="submit" name="submit_file" value="Upload Techers" class="btn btn-primary"/>
                 </form>
               </div>
                </div>
                <button type="button" onclick="getstudents()" class="btn btn-primary">For Students</button>
