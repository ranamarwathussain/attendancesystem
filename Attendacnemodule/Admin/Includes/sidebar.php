 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Assign/Unassign Class</h6>
             <a class="collapse-item" href="assign.php">Assign/Unassign Class</a>
                </div>
      ...
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Class Enrollment</h6>
            <a class="collapse-item" href="enrollment.php">Class Un/Enrollment</a>
...
<hr class="sidebar-divider">
      <div class="sidebar-heading">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrapcon111"
          aria-expanded="true" aria-controls="collapseBootstrapcon111">
          <i class="fa fa-calendar-alt"></i>
          <span>Take Attendance</span>
        </a>
         <div id="collapseBootstrapcon111" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Super Right</h6>
