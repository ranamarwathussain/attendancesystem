                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="number" min="1900" max="2099" step="1" class="form-control" name="sessionName" value="<?php //echo $row['sessionName'];?>" id="exampleInputFirstName" placeholder="Session" oninput="this.value = this.value.toUpperCase()">-->
