...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    where Id='$Id'");
      ...
      $query1=mysqli_query($conn,"update assignteacherclass set tname='$firstName'.'$lastName'
      where Id='$Id'");
                ...
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" required name="firstName" value="<?php echo $row['firstName'];?>" id="exampleInputFirstName" oninput="this.value = this.value.toUpperCase()">
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Lastname<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="lastName" value="<?php echo $row['lastName'];?>" id="exampleInputFirstName" oninput="this.value = this.value.toUpperCase()">
                        </div>
                    </div>
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Employee ID<span class="text-danger ml-2">*</span></label>
                        <input type="text" class="form-control" required name="emailAddress" value="<?php echo $row['emailAddress'];?>" id="exampleInputFirstName" oninput="this.value = this.value.toUpperCase()">
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Phone No<span class="text-danger ml-2">*</span></label>
                      <input type="NUMBER" class="form-control" name="phoneNo" value="<?php echo $row['phoneNo'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                  <!--  <div class="form-group row mb-3">
                        <div class="col-xl-6">
